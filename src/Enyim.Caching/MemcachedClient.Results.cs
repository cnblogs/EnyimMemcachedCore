...
namespace Enyim.Caching
{
    public partial class MemcachedClient : IMemcachedClient, IMemcachedResultsClient
    {
        ...
        public IStoreOperationResult ExecuteStore(StoreMode mode, string key, object value)
        {
            ...
            return PerformStore(mode, key, value, 0, ref tmp, out status);
        }
        ...
        public IStoreOperationResult ExecuteStore(StoreMode mode, string key, object value, TimeSpan validFor)
        {
            ...
            return PerformStore(mode, key, value, MemcachedClient.GetExpiration(validFor, null), ref tmp, out status);
        }
        ...
        public IStoreOperationResult ExecuteStore(StoreMode mode, string key, object value, DateTime expiresAt)
        {
            ...
            return PerformStore(mode, key, value, MemcachedClient.GetExpiration(null, expiresAt), ref tmp, out status);
        }
        ...
        {
            return PerformStore(mode, key, value, MemcachedClient.GetExpiration(validFor, null), cas);
        }
        ...
        {
            return PerformStore(mode, key, value, MemcachedClient.GetExpiration(null, expiresAt), cas);
        }
        #endregion
        ...
        {
            return PerformMutate(MutationMode.Increment, key, defaultValue, delta, MemcachedClient.GetExpiration(validFor, null));
        }
        ...
        {
            return PerformMutate(MutationMode.Increment, key, defaultValue, delta, MemcachedClient.GetExpiration(null, expiresAt));
        }
        ...
        {
            return PerformMutate(MutationMode.Decrement, key, defaultValue, delta, MemcachedClient.GetExpiration(validFor, null));
        }
        ...
        {
            return PerformMutate(MutationMode.Decrement, key, defaultValue, delta, MemcachedClient.GetExpiration(null, expiresAt));
        }
