...
namespace Enyim
{
    ...
    public sealed class TigerHash : HashAlgorithm
    {
        ...
        protected override byte[] HashFinal()
        {
            ...
            TigerHash.LongToBytes(((ulong)_totalLength) << 3, buffer, BLOCKSIZE - 8);

            ProcessBlock();

            byte[] retval = new byte[24];

            TigerHash.LongToBytes(_a, retval, 0);
            TigerHash.LongToBytes(_b, retval, 8);
            TigerHash.LongToBytes(_c, retval, 16);
        ...
        private unsafe void ProcessBlock()
        {
            ...
            Buffer.BlockCopy(_internalDataBuffer, 0, _block, 0, BLOCKSIZE);
        ...
        private void RoundABC(ulong x, uint mul)
        {
            ...
            _a -= T[cl & 0xFF] ^ T[((cl >> 16) & 0xFF) + 0x100] ^ T[(ch & 0xFF) + 0x200] ^ T[((ch >> 16) & 0xFF) + 0x300];
            _b += T[((cl >> 8) & 0xFF) + 0x300] ^ T[((cl >> 24) & 0xFF) + 0x200] ^ T[((ch >> 8) & 0xFF) + 0x100] ^ T[(ch >> 24) & 0xFF];
        ...
        private void RoundBCA(ulong x, uint mul)
        {
            ...
            _b -= T[al & 0xFF] ^ T[((al >> 16) & 0xFF) + 0x100] ^ T[(ah & 0xFF) + 0x200] ^ T[((ah >> 16) & 0xFF) + 0x300];
            _c += T[((al >> 8) & 0xFF) + 0x300] ^ T[((al >> 24) & 0xFF) + 0x200] ^ T[((ah >> 8) & 0xFF) + 0x100] ^ T[(ah >> 24) & 0xFF];
            _c *= mul;
        ...
        private void RoundCAB(ulong x, uint mul)
        {
            ...
            _c -= T[bl & 0xFF] ^ T[((bl >> 16) & 0xFF) + 0x100] ^ T[(bh & 0xFF) + 0x200] ^ T[((bh >> 16) & 0xFF) + 0x300];
            _a += T[((bl >> 8) & 0xFF) + 0x300] ^ T[((bl >> 24) & 0xFF) + 0x200] ^ T[((bh >> 8) & 0xFF) + 0x100] ^ T[(bh >> 24) & 0xFF];
            _a *= mul;
